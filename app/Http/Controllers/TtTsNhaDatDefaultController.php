...
class TtTsNhaDatDefaultController extends Controller
{
    ...
    public function edit(Request $request)
    {
        ...
        if(isset($inputs['id'])){
            ...
            $model = TtTsNhaDatDefault::where('id',$inputs['id'])
                ->first();
    ...
    public function update(Request $request)
    {
        ...
        if(isset($inputs['id'])){
            ...
            $modelupdate = TtTsNhaDatDefault::where('id',$inputs['id'])
                ->first();
    ...
    public function destroy(Request $request)
    {
        ...
        if(isset($inputs['id'])){
            $modeldel = TtTsNhaDatDefault::where('id',$inputs['id'])
                ->delete();
