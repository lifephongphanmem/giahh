...
class HsGiaHangHoaTW_LaoCaiController extends Controller
{
    public function danhmuc()
    {
        if(Session::has('admin')){
            $model = PNhomHangHoa::where('manhom','01')
                ->get();
            return view('manage.giahhdv.hhtw_laocai.danhmuc.index')
                ->with('model',$model)
    ...
    public function showthoidiem()
    {
        if(Session::has('admin')){
            $model = PNhomHangHoa::where('manhom','01')
                ->get();
            return view('manage.giahhdv.hhtw_laocai.danhmuc.showindex')
                ->with('model',$model)
    ...
    public function index($masopnhom,$nam)
    {
        if(Session::has('admin')){
            ...
            return view('manage.giahhdv.hhtw_laocai.index')
                ->with('model',$model)
                ->with('modelpb',$modelpb)
                ->with('masopnhom',$masopnhom)
                ->with('nam',$nam)
                ->with('url','/giahhdv-trunguong/')
    ...
    public function showindex($masopnhom,$nam,$pb)
    {
        if(Session::has('admin')){
            ...
            $modelpb = TtPhongBan::all();
            $this->getDetail($model);
            return view('manage.giahhdv.hhtw_laocai.showindex')
                ->with('model',$model)
                ->with('modelpb',$modelpb)
                ->with('nam',$nam)
                ->with('pb',$pb)
                ->with('masopnhom',$masopnhom)
                ->with('url','/thongtin-trunguong/')
                ->with('pageTitle','Thông tin hồ sơ giá hàng hóa do TW quy định');
        }else
            return view('errors.notlogin');
    }
    ...
    public function create($masopnhom)
    {
        if(Session::has('admin')){
            ...
            $hanghoa = DmHangHoa::select('masopnhom','mahh',DB::raw($mahuyen." as 'mahuyen'"),DB::raw("1 as 'soluong'"),DB::raw("0 as 'giatu'"),DB::raw("0 as 'giaden'"))->where('masopnhom',$masopnhom)->get();
            GiaHangHoaDefault::insert($hanghoa->toarray());
            ...
            return view('manage.giahhdv.hhtw_laocai.create')
                ->with('model',$model)
                ->with('masopnhom',$masopnhom)
                ->with('loaigia',$loaigia)
                ->with('loaihh',$loaihh)
                ->with('hanghoa',$dmhanghoa)
    ...
    public function create_dk($masopnhom)
    {
        if(Session::has('admin')){
            ...
            return view('manage.giahhdv.hhtw_laocai.create_dk')
                ->with('masopnhom',$masopnhom)
                ->with('loaigia',$loaigia)
                ->with('loaihh',$loaihh)
                ->with('thitruong',$thitruong)
    ...
    public function store(Request $request)
    {
        if(Session::has('admin')){
            ...
            return redirect('giahhdv-trunguong/maso='.$insert['masopnhom'].'&nam='.date_format($date,'Y'));
    ...
    public function show($id)
    {
        if(Session::has('admin')){
            ...
            return view('manage.giahhdv.hhtw_laocai.show')
                ->with('model',$model)
    ...
    public function view($id)
    {
        if(Session::has('admin')){
            ...
            return view('manage.giahhdv.hhtw_laocai.view')
                ->with('model',$model)
                ->with('modeltthh',$modeltthh)
                ->with('loaigia',$loaigia)
                ->with('loaihh',$loaihh)
    ...
    public function edit($id)
    {
        if(Session::has('admin')){
            ...
            return view('manage.giahhdv.hhtw_laocai.edit')
                ->with('model',$model)
                ->with('modeltthh',$modeltthh)
                ->with('loaigia',$loaigia)
                ->with('loaihh',$loaihh)
    ...
    public function edit_dk($id)
    {
        if(Session::has('admin')){
            ...
            $thitruong= DmThiTruong::all();
            //dd($modeltthh);
            return view('manage.giahhdv.hhtw_laocai.edit_dk')
                ->with('model',$model)
                ->with('loaigia',$loaigia)
                ->with('loaihh',$loaihh)
                ->with('thitruong',$thitruong)
    ...
    public function update(Request $request, $id)
    {
        if(Session::has('admin')){
            ...
            return redirect('giahhdv-trunguong/maso='.$model->masopnhom.'&nam='.date_format($date,'Y'));
    ...
    public function destroy(Request $request)
    {
        if(Session::has('admin')){
            ...
            return redirect('giahhdv-trunguong/maso='.$model->masopnhom.'&nam='.$model->nam);
        }else
            return view('errors.notlogin');
    }
    ...
    public function unapprove(Request $request){
        if(Session::has('admin')){
            ...
            */
                ...
                return redirect('giahhdv-trunguong/maso='.$model->masopnhom.'&nam='.$model->nam.'&pb=all');
    ...
    public function search(){
        if(Session::has('admin')){
            ...
            return view('manage.giahhdv.hhtw_laocai.search.create')
    ...
    public function viewsearch(Request $request){
        if(Session::has('admin')){
            ...
            return view('manage.giahhdv.hhtw_laocai.search.index')
                ->with('model',$model)
