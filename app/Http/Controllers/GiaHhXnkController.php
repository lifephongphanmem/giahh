...
class GiaHhXnkController extends Controller
{
    ...
    public function edit(Request $request)
    {
        ...
        if(isset($inputs['id'])){
            ...
            $model = GiaHhXnk::where('id',$inputs['id'])
                ->first();
            //dd($model);
    ...
    public function update(Request $request)
    {
        ...
        if(isset($inputs['id'])){
            ...
            $modelupdate = GiaHhXnk::where('id',$inputs['id'])
                ->first();
    ...
    public function destroy(Request $request)
    {
        ...
        if(isset($inputs['id'])){
            $modeldel = GiaHhXnk::where('id',$inputs['id'])
                ->first();
            $modeldel->delete();
