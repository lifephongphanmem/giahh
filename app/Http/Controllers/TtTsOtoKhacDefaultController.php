...
class TtTsOtoKhacDefaultController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(isset($inputs['tents']) && $inputs['tents']!= ''){
            $modelts = new TtTsOtoKhacDefault();
            ...
            if(count($model) > 0){
                foreach($model as $key=>$tents){
                    ...
                    $result['message'] .= '<td style="text-align: right">'.$tents->tstk.'</td>';
    ...
    public function edit(Request $request)
    {
        ...
        if(isset($inputs['id'])){
            ...
            $model = TtTsOtoKhacDefault::where('id',$inputs['id'])
                ->first();
            ...
            $result['message'] .= '<div><input type="text" name="tsktedit" id="tsktedit" class="form-control" data-mask="fdecimal" value="'.$model->tskt.'"></div>';
            $result['message'] .= '</div>';
            $result['message'] .= '</div>';
            $result['message'] .= '<div class="col-md-6">';
    ...
    public function update(Request $request)
    {
        ...
        if(isset($inputs['id'])){
            ...
            $modelupdate = TtTsOtoKhacDefault::where('id',$inputs['id'])
                ->first();
    ...
    public function destroy(Request $request)
    {
        ...
        if(isset($inputs['id'])){
            $modeldel = TtTsOtoKhacDefault::where('id',$inputs['id'])
                ->delete();
