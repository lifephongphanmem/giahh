...
class GiaHhTtDefaultController extends Controller
{
    public function gettthh(Request $request)
    {
        ...
        if(isset($inputs['manhom'])){
            $model = DmHhTn55::where('masopnhom',$inputs['manhom'])
                ->get();
            //dd($model);
    ...
    public function store(Request $request)
    {
        ...
        if($inputs['mahh']!=''){
            ...
            $model = GiaHhTtDefault::where('mahuyen',session('admin')->mahuyen)
                ->get();
    ...
    public function edit(Request $request)
    {
        ...
        if(isset($inputs['id'])){
            ...
            $model = GiaHhTtDefault::where('id',$inputs['id'])
                ->first();
            //dd($model);
    ...
    public function destroy(Request $request)
    {
        ...
        if(isset($inputs['id'])){
            $modeldel = GiaHhTtDefault::where('id',$inputs['id'])
                ->delete();
