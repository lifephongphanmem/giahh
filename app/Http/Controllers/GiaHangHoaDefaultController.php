...
class GiaHangHoaDefaultController extends Controller
{
    public function gettthh(Request $request)
    {
        ...
        if(isset($inputs['mapnhom'])){
            $model = DmHangHoa::where('masopnhom',$inputs['mapnhom'])->get();
    ...
    public function store(Request $request)
    {
        ...
        $m_kt=GiaHangHoaDefault::where('mahh',$mahh)->where('mahuyen',$mahuyen)->get();
        if(count($m_kt)>0){
            $result = array(
                'status' => 'fail',
        ...
        if($inputs['mahh']!=''){
            ...
            $model = GiaHangHoaDefault::where('mahuyen',session('admin')->mahuyen)->get();
            $dmhanghoa = array_column(DmHangHoa::get()->toarray(),'tenhh','mahh');
            foreach($model as $ct){
    ...
    public function edit(Request $request)
    {
        ...
        if(isset($inputs['id'])){
            ...
            $model = GiaHangHoaDefault::where('id',$inputs['id'])->first();
            //dd($model);
    ...
    public function update(Request $request)
    {
        ...
        if(isset($inputs['id'])){
            ...
            $modelupdate = GiaHangHoaDefault::where('id',$inputs['id'])
                ->first();
    ...
    public function destroy(Request $request)
    {
        ...
        if(isset($inputs['id'])){
            $modeldel = GiaHangHoaDefault::where('id',$inputs['id'])->delete();
