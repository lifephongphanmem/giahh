...
class giathuedatController extends Controller
{
    ...
    public function index(Request $request)
    {
        if (Session::has('admin')) {
            ...
            return view('manage.giadat.vitri.thuedat.index')
                ->with('model',$model)
                ->with('nam',$inputs['nam'])
    ...
    public function showindex(Request $request){
        if(Session::has('admin')){
            ...
            return view('manage.giadat.vitri.thuedat.showindex')
                ->with('model',$model)
    ...
    public function create()
    {
        if(Session::has('admin')){
            ...
            return view('manage.giadat.vitri.thuedat.create')
    ...
    public function show($id)
    {
        if(Session::has('admin')){
            ...
            return view('manage.giadat.vitri.thuedat.show')
                ->with('model',$model)
                ->with('pageTitle','Thông tin giá đất cho thuê');
        }else
            return view('errors.notlogin');
    ...
    public function edit($id)
    {
        if(Session::has('admin')){
            ...
            return view('manage.giadat.vitri.thuedat.edit')
                ->with('model',$model)
                ->with('model_diaban',$model_diaban)
                ->with('model_phanloai',$model_phanloai)
                ->with('model_vitri',$model_vitri)
