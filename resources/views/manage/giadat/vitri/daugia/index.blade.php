...
@section('content')
    ...
    <h3 class="page-title">
        Thông tin giá đất<small> đấu giá</small>
    </h3>
                ...
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover" id="sample_3">
                        ...
                        <tr>
                            ...
                            <th style="text-align: center">Tên thửa đất</th>
                            <th style="text-align: center">Vị trí đất</th>
                            <th style="text-align: center" >Đơn giá</br>(danh mục)</th>
                            <th style="text-align: center" >Đơn giá</br>đấu giá</th>
                        ...
                        @foreach($model as $key=>$tt)
                            <tr>
                                ...
                                <td class="active">{{$tt->tenthuadat}}</td>
                                <td class="active">{{$tt->vitri}}</td>
                                <td>{{number_format($tt->giagoc)}}</td>
                                <td>{{number_format($tt->giadaugia)}}</td>
                                <td class="text-center">{{getDayVn($tt->ngaynhap)}}</td>
