...
@section('content')
    <h3 class="page-title">
        Thông tin giá đất cho thuê <small> chỉnh sửa</small>
    </h3>
    <!-- END PAGE HEADER-->
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                        {!! Form::open(['url'=>'/giadat/thuedat/'.$model->id, 'id' => 'create_kekhai', 'class'=>'horizontal-form','method'=>'patch']) !!}
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">Giá thuê đất <span class="require">*</span></label>
                                        <input type="text" name="giathuedat" id="giathuedat" class="form-control" data-mask="fdecimal" required="required" value="{{$model->giathuedat}}">
                                    </div>
                                </div>
                                <!--/span-->
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="ngaytu" name="ngaytu" class="form-control required" value="{{$model->ngaytu}}" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">Đến ngày</label>
                                        <input type="date" id="ngayden" name="ngayden" class="form-control required" value="{{$model->ngayden}}" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label">Đơn vị thuê đất</label>
                                        <textarea id="tendonvi" class="form-control" name="tendonvi" rows="3">{{$model->tendonvi}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
