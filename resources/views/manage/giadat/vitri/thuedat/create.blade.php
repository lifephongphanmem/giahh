...
@section('content')
    <h3 class="page-title">
        Thông tin giá đất cho thuê <small> thêm mới</small>
    </h3>
    <!-- END PAGE HEADER-->
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                        {!! Form::open(['url'=>'/giadat/thuedat/store', 'id' => 'create_kekhai', 'class'=>'horizontal-form','method'=>'post']) !!}
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="giathuedat" id="giathuedat" class="form-control" data-mask="fdecimal" required="required" value="0">
                                    </div>
                                </div>
                                <!--/span-->
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="ngaytu" name="ngaytu" class="form-control required" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="tendonvi" class="form-control" name="tendonvi" rows="3"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
