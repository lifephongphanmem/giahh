    ...
    <script>
        ...
        $(function(){
            $('#namhs').change(function() {
                var namhs = $('#namhs').val();
                var url = '/hoso-congbobosung/nam='+namhs;
...
@section('content')
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="actions">
                        ...
                        <a href="{{url('hoso-congbobosung/create')}}" class="btn btn-default btn-sm">
                            <i class="fa fa-plus"></i> Thêm mới hồ sơ chi tiết</a>
                        <a href="{{url('hoso-congbobosung-dk/create')}}" class="btn btn-default btn-sm">
                            <i class="fa fa-plus"></i> Thêm mới hồ sơ đính kèm</a>
                        <a href="{{url('hoso-congbobosung/import')}}" class="btn btn-default btn-sm">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($tt->trangthai == 'Hoàn tất')
                                        ...
                                        @else
                                            <a href="{{url('hoso-congbobosung/'.$tt->id.'/show')}}" class="btn btn-default btn-xs mbs"><i class="fa fa-eye"></i>&nbsp;Chi tiết</a>
                                        @endif
                                    @else
                                        @if(can('congbogia','edit'))
                                            @if($tt->phanloai == 'DINHKEM')
                                                <a href="{{url('hoso-congbobosung-dk/'.$tt->id.'/edit')}}" class="btn btn-default btn-xs mbs"><i class="fa fa-edit"></i>&nbsp;Chỉnh sửa</a>
                                            @else
                                                <a href="{{url('hoso-congbobosung/'.$tt->id.'/edit')}}" class="btn btn-default btn-xs mbs"><i class="fa fa-edit"></i>&nbsp;Chỉnh sửa</a>
                                            @endif
                                        @endif
    ...
    <div id="delete-modal-confirm" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
        {!! Form::open(['url'=>'hoso-congbobosung/delete','id' => 'frm_delete'])!!}
    ...
    <div id="hoantat-modal-confirm" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
        {!! Form::open(['url'=>'hoso-congbobosung/hoantat','id' => 'frm_hoantat'])!!}
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header modal-header-primary">
                    <button type="button" data-dismiss="modal" aria-hidden="true"
