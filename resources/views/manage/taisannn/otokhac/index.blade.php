    ...
    <script>
        ...
        $(function(){
            $('#namhs').change(function() {
                var namhs = $('#namhs').val();
                var url = '/taisan-otokhac/nam='+namhs+'&pb=all';
            ...
            $('#ttpb').change(function() {
                var namhs = $('#namhs').val();
                var ttpb = $('#ttpb').val();
                var url = '/taisan-otokhac/nam='+namhs+'&pb='+ttpb;
...
@section('content')
    <h3 class="page-title">
        Thông tin tài sản nhà nước<small>&nbsp;(tài sản là ôtô, tài sản khác)</small>
    </h3>
    <div class="row">
        <div class="col-md-2">
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="actions">
                        <a href="{{url('taisan-otokhac/create')}}" class="btn btn-default btn-sm">
                        ...
                        @foreach($model as $key=>$tt)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{url('taisan-otokhac/'.$tt->id.'/edit')}}" class="btn btn-default btn-xs mbs"><i class="fa fa-edit"></i>&nbsp;Chỉnh sửa</a>
    ...
    <div id="delete-modal-confirm" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
        {!! Form::open(['url'=>'taisan-otokhac/delete','id' => 'frm_delete'])!!}
