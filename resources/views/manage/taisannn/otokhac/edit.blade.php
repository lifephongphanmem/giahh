...
@section('content')
    <h3 class="page-title">
        Thông tin tài sản nhà nước (tài sản là ôtô, tài sản khác)<small> chỉnh sửa</small>
    </h3>
    <!-- END PAGE HEADER-->
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::model($model, ['method' => 'PATCH', 'url'=>'taisan-otokhac/'. $model->id, 'class'=>'horizontal-form','id'=>'update_ttts']) !!}
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="ngaynhap" name="ngaynhap" class="form-control required" value="{{$model->ngaynhap}}" autofocus>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tskt" id="tskt" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @if(count($modeltt)>0)
                                            @foreach($modeltt as $key=>$tt)
                                                <tr>
                                                    ...
                                                    <td style="text-align: right">{{$tt->tskt}}</td>
                                            ...
                                            @endforeach
                                        @else
                                            <td colspan="8" style="text-align: center">Chưa có thông tin</td>
                                        @endif
                                        </tbody>
                                        </table>
                                    </div>
    ...
    <script type="text/javascript">
        function validateForm(){
            ...
            var validator = $("#update_ttts").validate({
                rules: {
                    ten :"required"
                },
                messages: {
