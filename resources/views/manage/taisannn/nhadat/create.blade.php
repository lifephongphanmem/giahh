...
@section('content')
    <h3 class="page-title">
        Thông tin tài sản nhà nước (tài sản là nhà, đất)<small> thêm mới</small>
    </h3>
    <!-- END PAGE HEADER-->
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                        {!! Form::open(['url'=>'taisan-nhadat', 'id' => 'create_ttts', 'class'=>'horizontal-form']) !!}
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="ngaynhap" name="ngaynhap" class="form-control required" autofocus>
                                    </div>
                                </div>
                            </div>
