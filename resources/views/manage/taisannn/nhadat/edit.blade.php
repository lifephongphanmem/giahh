...
@section('custom-script')
    ...
    <script>
        ...
        function updatets(){
            ...
            var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
            $.ajax({
                url: '/tttsnhadat/update',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    id: $('input[name="idedit"]').val(),
                    tents: $('input[name="tentsedit"]').val(),
                    slts: $('input[name="sltsedit"]').val(),
                    sotang: $('input[name="sotangedit"]').val(),
                    dientich: $('input[name ="dientichedit"]').val(),
                    tyleclcl: $('input[name="tyleclcledit"]').val(),
                    nguyengia: $('input[name="nguyengiaedit"]').val(),
                    giatricl: $('input[name="giatricledit"]').val()
                },
                dataType: 'JSON',
                success: function (data) {
...
@section('content')
    <h3 class="page-title">
        Thông tin tài sản nhà nước (tài sản là nhà, đất)<small> chỉnh sửa</small>
    </h3>
    <!-- END PAGE HEADER-->
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::model($model, ['method' => 'PATCH', 'url'=>'taisan-nhadat/'. $model->id, 'class'=>'horizontal-form','id'=>'update_ttts']) !!}
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="ngaynhap" name="ngaynhap" class="form-control required" autofocus value="{{$model->ngaynhap}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group has-error">
                                        <label class="control-label">Số lượng tài sản</label>
                                        <input type="text" id="slts" name="slts" class="form-control" data-mask="fdecimal" value="1">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="sotang" id="sotang" class="form-control" data-mask="fdecimal" value="1">
                                    </div>
                                </div>
                                <!--/span-->
                                <div class="col-md-6">
                                    <div class="form-group has-error">
                                        <label class="control-label">Diện tích (m<sup>2</sup>)</label>
                                        <input type="text" name="dientich" id="dientich" class="form-control" data-mask="fdecimal" value="0">
                                    </div>
                                </div>
                                <!--/span-->
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">Tỷ lệ chất lượng còn lại(%)<span class="require">*</span></label>
                                        <input type="text" name="tyleclcl" id="tyleclcl" class="form-control" data-mask="fdecimal" value="0">
                                    </div>
                                </div>
                                <!--/span-->
                                <div class="col-md-6">
                                    <div class="form-group has-error">
                                        ...
                                        <input type="text" name="nguyengia" id="nguyengia" class="form-control" data-mask="fdecimal" value="0">
                                    </div>
                                </div>
                                <!--/span-->
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">Giá trị còn lại<span class="require">*</span></label>
                                        <input type="text" name="giatricl" id="giatricl" class="form-control" data-mask="fdecimal" value="0">
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        function validateForm(){
            ...
            var validator = $("#create_ttts").validate({
                rules: {
                    ten :"required"
                },
                messages: {
    ...
    <script>
        jQuery(document).ready(function($) {
            $('button[name="capnhatts"]').click(function(){
                var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
                $.ajax({
                    url: '/tttsnhadat/store',
                    type: 'GET',
                    data: {
                        _token: CSRF_TOKEN,
                        tents: $('input[name="tents"]').val(),
                        slts: $('input[name="slts"]').val(),
                        sotang: $('input[name="sotang"]').val(),
                        dientich: $('input[name="dientich"]').val(),
                        tyleclcl: $('input[name="tyleclcl"]').val(),
                        nguyengia: $('input[name="nguyengia"]').val(),
                        giatricl: $('input[name = "giatricl"]').val(),
                        mahs: $('#mahs').val()
                    },
                    dataType: 'JSON',
                    success: function (data) {
