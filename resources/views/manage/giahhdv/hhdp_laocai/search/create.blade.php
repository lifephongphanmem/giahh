...
@section('content')
    ...
    <h3 class="page-title">
        Tìm kiếm thông tin giá hàng hóa thị trường<small> do địa phương quy định</small>
    </h3>
    <!-- END PAGE HEADER-->
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['url'=>'timkiem-giahhdv-diaphuong', 'id' => 'create_tkcongbogia', 'class'=>'horizontal-form']) !!}
