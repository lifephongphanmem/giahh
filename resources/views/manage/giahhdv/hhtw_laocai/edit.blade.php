        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                        {!! Form::model($model, ['method' => 'PATCH', 'url'=>'giahhdv-trunguong/'. $model->id, 'class'=>'horizontal-form','id'=>'update_ttgiahhdvtn']) !!}
                        <div class="form-body">
            ...
            <div class="row">
                <div class="col-md-12" style="text-align: center">
                    ...
                    <a href="{{url('giahhdv-trunguong/maso='.$model->masopnhom.'&nam='.date('Y'))}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
                </div>
            </div>
            </form>
        </div>
