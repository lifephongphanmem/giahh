        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                        {!! Form::open(['url'=>'giahhdv-trunguong', 'id' => 'create_kekhai', 'class'=>'horizontal-form','method'=>'post']) !!}
                        <div class="form-body">
            ...
            <div class="row">
                <div class="col-md-12" style="text-align: center">
                    ...
                    <a href="{{url('giahhdv-trunguong/maso='.$masopnhom.'&nam='.date('Y'))}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
                </div>
            </div>
            </form>
        </div>
