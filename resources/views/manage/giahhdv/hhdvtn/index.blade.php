    ...
    <script>
        ...
        $(function(){
            $('#nambc').change(function() {
                ...
                var url = '/giahhdv-trongnuoc/thoidiem='+thoidiem+'/nam='+nambc+'&pb=all';
            ...
            $('#ttpb').change(function() {
                ...
                var ttpb = $('#ttpb').val();
                var thoidiem = $('#thoidiem').val();
                var url = '/giahhdv-trongnuoc/thoidiem='+thoidiem+'/nam='+nambc+'&pb='+ttpb;
...
@section('content')
    ...
    <h3 class="page-title">
        Thông tin hồ sơ<small>&nbsp;giá hàng hóa dịch vụ trong nước</small>
    </h3>
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        ...
                        <a href="{{url('giahhdv-trongnuoc/thoidiem='.$thoidiem.'/create')}}" class="btn btn-default btn-sm">
                        ...
                        @foreach($model as $key=>$tt)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{url('giahhdv-trongnuoc/'.$tt->id.'/edit')}}" class="btn btn-default btn-xs mbs"><i class="fa fa-edit"></i>&nbsp;Chỉnh sửa</a>
                                    @endif
                                    @if(can('hhdvtn','delete') && $tt->mahuyen == session('admin')->mahuyen)
                ...
                <div class="col-md-offset-5 col-md-2">
                    <a class="btn blue" href="{{url('/giahhdv-trongnuoc')}}"><i class="fa fa-mail-reply"></i>  Quay lại</a>
                </div>
            </div>
    ...
    <div id="delete-modal-confirm" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
        {!! Form::open(['url'=>'giahhdv-trongnuoc/delete','id' => 'frm_delete'])!!}
