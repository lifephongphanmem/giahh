                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="maloaihh" name="maloaihh" readonly>
                        ...
                        <div class="form-actions right">
                            <a href="{{url('giahhdv-trongnuoc/thoidiem='.$model->mathoidiem.'/nam='.$model->nam.'&pb=all')}}" class="btn green"><i class="fa fa-mail-reply"></i>&nbsp;Quay lại</a>
                        </div>
                    </form>
                    <!-- END FORM-->
                </div>
