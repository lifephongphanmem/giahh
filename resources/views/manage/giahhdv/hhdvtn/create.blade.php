        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                        {!! Form::open(['url'=>'giahhdv-trongnuoc', 'id' => 'create_ttgiahhdvtn', 'class'=>'horizontal-form']) !!}
                        <div class="form-body">
