                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_3">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{url('giahhdv-thitruong/thoidiem='.$tt->mathoidiem.'/nam='.getGeneralConfigs()['namhethong'].'&pb=all')}}" class="btn btn-default btn-xs mbs">
                                    <i class="fa fa-edit"></i> Nhập báo cáo</a>
                                @else
                                    <a href="{{url('giahhdv-thitruong/thoidiem='.$tt->mathoidiem.'/nam='.getGeneralConfigs()['namhethong'].'&pb='.session('admin')->mahuyen)}}" class="btn btn-default btn-xs mbs">
                                        <i class="fa fa-edit"></i> Nhập báo cáo</a>
                                @endif
                            </td>
                        </tr>
