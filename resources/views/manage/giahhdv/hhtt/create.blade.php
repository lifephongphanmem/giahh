        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['url'=>'giahhdv-thitruong/store', 'id' => 'create_ttgiahhdvtn', 'class'=>'horizontal-form']) !!}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::date('tgnhap', date('Y-m-d'), array('id' => 'tgnhap', 'class' => 'form-control', 'readonly'=>'true'))!!}
                                </div>
                            </div>
                            <!--/span-->
                            <div class="col-md-6">
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if(data.status == 'success') {
                            ...
                            toastr.error("Thông tin hàng hóa, dịch vụ đã tồn tại hoặc có lỗi trong nhập liệu!", "Lỗi!");
                            $('#manhom').focus();
                        }
                    }
                })
