...
@section('content')
    ...
    <h3 class="page-title">
        Chọn thời điểm xem<small>&nbsp;báo cáo giá hàng hóa do TW quy định</small>
    </h3>
    <!-- END PAGE HEADER-->
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_3">
                        ...
                        <tr>
                            ...
                            <td>{{$tt->nhom}}</td>
                            <td>
                                <a href="{{url('thongtin-tw/thoidiem='.$tt->mathoidiem.'/nam='.getGeneralConfigs()['namhethong'].'&pb=all')}}" class="btn btn-default btn-xs mbs">
