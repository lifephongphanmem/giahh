...
@section('content')
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::model($model, ['method' => 'PATCH', 'url'=>'giahh-xuatnhapkhau/'. $model->id, 'class'=>'horizontal-form','id'=>'update_ttgiahhxnk']) !!}
                        <div class="form-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="maloaigia" name="maloaigia">
                                            @foreach($loaigia as $key=>$tt)
                                                <option value="{{$tt->maloaigia}}" {{($tt->maloaigia == $model->maloaigia) ? 'selected' : ''}}>{{$tt->tenloaigia}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        function validateForm(){
            ...
            var validator = $("#update_ttgiahhxnk").validate({
                rules: {
                    ten :"required"
                },
                messages: {
