    ...
    <script>
        ...
        $(function(){
            $('#nambc').change(function() {
                ...
                var url = '/thongtin-dp/thoidiem='+thoidiem+'/nam='+nambc+'&pb=all';
            ...
            $('#ttpb').change(function() {
                ...
                var ttpb = $('#ttpb').val();
                var thoidiem = $('#thoidiem').val();
                var url = '/thongtin-dp/thoidiem='+thoidiem+'/nam='+nambc+'&pb='+ttpb;
...
@section('content')
    ...
    <h3 class="page-title">
        Thông tin hồ sơ<small>&nbsp;giá hàng hóa, dịch vụ do TW quy định</small>
    </h3>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                        ...
                        @foreach($model as $key=>$tt)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        <a href="{{url('thongtin-dp/'.$tt->id.'/show')}}" class="btn btn-default btn-xs mbs"><i class="fa fa-eye"></i>&nbsp;Chi tiết</a>
                                    @endif
                ...
                <div class="col-md-offset-5 col-md-2">
                    <a class="btn blue" href="{{url('/thongtin-dp')}}"><i class="fa fa-mail-reply"></i>  Quay lại</a>
                </div>
            </div>
