...
@section('content')
    <h3 class="page-title">
        Thông tin giá hàng hóa, dịch vụ do TW quy định<small> xem chi tiết</small>
    </h3>
    <!-- END PAGE HEADER-->
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                        ...
                        <div class="form-actions right">
                            <a href="{{url('giahhdv-tw/thoidiem='.$model->mathoidiem.'/nam='.$model->nam)}}" class="btn green"><i class="fa fa-mail-reply"></i>&nbsp;Quay lại</a>
                        </div>
                    </form>
                    <!-- END FORM-->
                </div>
