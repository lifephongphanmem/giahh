...
@section('content')
    ...
    <h3 class="page-title">
        Danh mục loại giá<small>&nbsp;báo cáo</small>
    </h3>
    <!-- END PAGE HEADER-->
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="portlet box wi">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a href="{{url('dmloaihh/create')}}" class="btn btn-default btn-sm">
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_3">
                        ...
                        <tr>
                            ...
                            <th style="text-align: center">Mã loại hàng hóa</th>
                            <th style="text-align: center">Tên loại hàng hóa</th>
                        ...
                        <tr>
                            ...
                            <td>{{$tt->maloaihh}}</td>
                            <td class="success">{{$tt->tenloaihh}}</td>
                            <td>{{$tt->gc}}</td>
                            <td>
    ...
    <div class="modal fade" id="delete-modal-confirm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['url'=>'dmloaihh/delete','id' => 'frm_delete'])!!}
